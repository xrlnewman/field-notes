...
- **平台运营**：维护商户入驻、类目、轮播、活动和平台公告，按商户查看经营数据。
- **商户中心**：商户维护商品、规格、库存、上下架状态和发货信息，平台可以审核异常商品。
- **购物履约**：顾客浏览、加购、下单和支付后进入待发货、配送中、已完成与售后状态。
- **售后与结算**：退款申请关联订单和商品，平台按商户、订单和佣金生成结算明细。

## 数据与验收

商品、规格、库存、订单、发货、退款和商户结算通过订单号关联。验收路径为“商户上架—顾客下单—商户发货—顾客收货—申请售后—平台结算”，库存和金额变化均保留流水。
