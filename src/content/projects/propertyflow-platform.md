...
- **报修受理**：住户提交位置、问题类型、图片说明和期望上门时间，系统生成工单与 SLA。
- **派单调度**：主管按区域、技能和负载派给维修人员，支持转派、改约和超时升级。
- **过程记录**：维修人员记录到场、处理方案、材料和费用，住户可在线确认处理结果。
- **验收统计**：工单完成后进入验收与评价，后台按小区、工种、时效和满意度分析服务质量。

## 数据与验收

工单、派单、上门记录、材料、验收和评价形成一条事件链。验收流程为“提交报修—派单—上门—填写处理—住户验收—评价”，超时工单会自动进入风险队列。
